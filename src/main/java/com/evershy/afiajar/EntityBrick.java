...
public class EntityBrick extends EntityThrowable
{
	public static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entities/projectiles/brick.png");
		...
		public EntityBrick(World worldIn)
	    {
	        super(worldIn);
	    }

	    public EntityBrick(World worldIn, EntityLivingBase throwerIn)
	    {
	    	super(worldIn, throwerIn);
	    }

	    public EntityBrick(World worldIn, double x, double y, double z)
	    {
	        super(worldIn, x, y, z);
	    }
