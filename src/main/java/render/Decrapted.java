...
public class Decrapted extends Render<EntityPebble>
{
/**	public static final ResourceLocation MODEL = new ResourceLocation(Reference.MOD_ID + ":" + "models/entity/PebbleModel.java");
	
	private final ResourceLocation texture;

	public Decrapted(final RenderManager manager, final ResourceLocation textureResource) 
	{
		super(manager);
		texture = textureResource;
	}
	@Override
	public void doRender(EntityPebble entity, double x, double y, double z, float entityYaw, float partialTicks) {
